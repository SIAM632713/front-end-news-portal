...
const ShowComment = ({refetch,userData}) => {
    ...
    //  likedComments state from localStorage
    ...
    return (
        <div className="max-w-[900px] mx-auto mt-6 rounded-md p-4 bg-white shadow-md">
            ...
            {userData.length > 0 ? (
                userData.map((item, index) => (
                    <div key={index} className="flex flex-col sm:flex-row items-start gap-3 mb-6 border-b pb-4">
                        {/* Avatar */}
                        <img
                            src={image}
                            alt="avatar"
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm mt-1 text-gray-700 break-words">{item?.comment}</p>
