                ...
                <nav className="hidden md:flex items-center space-x-8">
                    ...
                    {token ? (
                        <div className="flex items-center space-x-4">
                            <Link to={user?.role === "admin" ? "/dashboard/admin" : "/dashboard/profile"}>
                                <button className="bg-black text-white px-5 py-2 rounded-md hover:bg-transparent hover:text-black border border-black transition duration-300 text-sm font-medium">
                                    Dashboard
                                </button>
                            </Link>
                            <button
                                onClick={handleLogout}
                                className="bg-black text-white px-5 py-2 rounded-md hover:bg-transparent hover:text-black border border-black transition duration-300 text-sm font-medium"
                            >
                                Logout
                            </button>
                        </div>
                        ...
                        {token ? (
                            <>
                                <Link
                                    ...
                                    onClick={toggleMobileMenu}
                                >
                                    <button className="bg-black text-white px-4 py-2 rounded-md hover:bg-transparent hover:text-black border border-black transition duration-300 text-sm font-medium w-full text-left">
                                        Dashboard
                                    </button>
                                </Link>
                                <button
                                    ...
                                    className="bg-black text-white px-4 py-2 rounded-md hover:bg-transparent hover:text-black border border-black transition duration-300 text-sm font-medium w-full text-left"
                                >
                                    Logout
                                </button>
                            </>
                            ...
                            <Link to="/login" onClick={toggleMobileMenu}>
                                <button className="bg-black text-white px-4 py-2 rounded-md hover:bg-transparent hover:text-black border border-black transition duration-300 text-sm font-medium w-full">
                                    Login
                                </button>
                            </Link>
                        )}
